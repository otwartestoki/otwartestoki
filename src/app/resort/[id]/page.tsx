...
type ResortStats = {
  ...
  // nadal może istnieć (np. featured), ale NIE opieramy widoku skipassów tylko na tym
...
/** ✅ sprawdza czy cena jest ważna na dany dzień (domyślnie "dziś") */
...
/** ✅ slug--id => zwraca ID zawsze jako STRING (bez Number) */
...
export default function ResortPage() {
  ...
  // ✅ zoom: domyślnie dopasuj (fit), a +/- dla usera
  ...
  // ✅ czy w ogóle potrzebujemy przewijania?
  ...
  function computeFitZoom() {
    ...
    // contain, bez powiększania ponad 1×
  ...
  async function loadSkipasses(resortUuid: string) {
    ...
    // 2) pobierz ceny dla tych produktów (uwzględnij valid_from/valid_to)
    ...
    // sort: najtańsze na górze, potem nazwa
    final.sort((a, b) => {
    ...
    <div style={{ minHeight: "100vh", background: "#ffffff", fontFamily: "system-ui, Arial" }}>
      ...
      <main style={{ padding: 20, maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: 16, alignItems: "baseline" }}>
          <div>
            <h1 style={{ fontSize: 26, fontWeight: 800, margin: "12px 0 0", letterSpacing: -0.2 }}>{resort?.name ?? "—"}</h1>
        ...
        >
          ...
          <div style={{ border: "1px solid #e2e8f0", borderRadius: 14, background: "#ffffff", padding: 12, marginTop: 14 }}>
            <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "baseline" }}>
              <div style={{ fontSize: 12, color: "#64748b", fontWeight: 800 }}>Długość tras wg trudności</div>
